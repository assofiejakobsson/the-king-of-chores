...
from .views import home, todo_complete, todo_list, todo_create, todo_delete, todo_view, todo_update, update_completed_by, todo_completed_update, todo_completed_delete
